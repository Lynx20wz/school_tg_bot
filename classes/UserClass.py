...
class UserClass:
    ...
    @classmethod
    def get_user_from_massive(cls, username: str, mode: int = 1) -> Optional[Union[Tuple[str, int, bool, bool, bool], 'UserClass', int]]:
        """
        ...
        def wrapper(func: Callable[P, T]):
            ...
            async def wrapped(message: Union[Message, UserClass], *args, **kwargs):
                if isinstance(message, UserClass):
                    ...
                    existing_user = UserClass.get_user_from_massive(message.from_user.username, 2)
                    if existing_user:
                        user = existing_user
                    else:
    ...
    def save_settings(
        self, database, setting_dw: bool = None, setting_notification: bool = None, debug: bool = None, save_db: bool = False
    ):
        """
        ...
        user_index = UserClass.get_user_from_massive(self.username, 3)
